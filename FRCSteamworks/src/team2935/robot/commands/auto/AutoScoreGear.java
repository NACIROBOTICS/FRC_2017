 ...
 *
 */
public class AutoScoreGear extends Command {
	double timeout;
    public AutoScoreGear(double timeout) {
    ...
    protected void execute() {
    	Robot.gearSubsystem.openClaw();
    	Robot.gearSubsystem.clawState = States.CLAW_OPEN;
    }
